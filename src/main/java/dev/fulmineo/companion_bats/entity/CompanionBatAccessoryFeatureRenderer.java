...
public class CompanionBatAccessoryFeatureRenderer extends FeatureRenderer<CompanionBatEntity, CompanionBatEntityModel> {
    ...
    public CompanionBatAccessoryFeatureRenderer(FeatureRendererContext<CompanionBatEntity, CompanionBatEntityModel> featureRendererContext, EntityModelLoader entityModelLoader) {
