...
@OnlyIn(Dist.CLIENT)
public class CompanionBatEntityModel extends SegmentedModel<CompanionBatEntity> {
	...
	public CompanionBatEntityModel() {
		this.texWidth = 64;
		this.texHeight = 64;
	...
	public void setupAnim(CompanionBatEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
		if (p_225597_1_.isRoosting()) {
