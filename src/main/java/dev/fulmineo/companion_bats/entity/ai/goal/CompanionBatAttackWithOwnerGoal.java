	...
	public boolean canStart() {
		if (this.entity.isTamed() && !this.entity.isSitting()) {
			...
			if (livingEntity == null) {
				...
				return i != this.lastAttackTime && this.canTrack(this.attacking, TargetPredicate.createAttackable().ignoreVisibility()) && this.entity.canAttackWithOwner(this.attacking, livingEntity);
			}
		} else {
			return false;
		}
