    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (world instanceof ServerWorld) {
            ...
            if (user.isSneaking()){
                ...
                inventory.setStack(0, ItemStack.fromTag(entityData.getAccessory()));
                inventory.setStack(1, ItemStack.fromTag(entityData.getArmor()));
				inventory.setStack(2, ItemStack.fromTag(entityData.getBundle()));
